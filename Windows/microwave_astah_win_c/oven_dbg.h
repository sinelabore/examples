...
const char oven_states[]=
	"Error\0Idle\0Cooking\0CookingPause\0Completed\0Super\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Error,Idle,Cooking,CookingPause,Completed,Super,__OVEN_LAST_STATE__
};


#define InnermostStates "Error,Idle,Cooking,CookingPause,Completed;"
const unsigned short oven_state_idx[]={
	0,6,11,19,32,42,48,68};
