#ifndef __OVEN_HLP_H__
#define __OVEN_HLP_H__
...
// starts timer
// Returns either ON if started or TIMER_OFF if not started (e.g. preset=0)
T_TIMER_STATE timer_start(void);

// stops timer
void stop_timer(void);

// either returns ON or TIMER_OFF or PAUSE
...
// Switch TIMER_OFF microwave generator
void ovenOff(void);
