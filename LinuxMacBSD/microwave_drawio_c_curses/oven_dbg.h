...
const char oven_states[]=
	"Super\0Completed\0CookingPause\0Error\0Idle\0Cooking\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Super,Completed,CookingPause,Error,Idle,Cooking,__OVEN_LAST_STATE__
};


#define InnermostStates "Completed,CookingPause,Error,Idle,Cooking;"
const unsigned short oven_state_idx[]={
	0,6,16,29,35,40,48,68};
