...
const char oven_states[]=
	"Super\0Completed\0Idle\0Cooking\0CookingPause\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Super,Completed,Idle,Cooking,CookingPause,__OVEN_LAST_STATE__
};


#define InnermostStates "Completed,Idle,Cooking,CookingPause;"
