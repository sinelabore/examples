...
const char oven_states[]=
	"Idle\0Super\0Completed\0Cooking\0CookingPause\0Error\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Idle,Super,Completed,Cooking,CookingPause,Error,__OVEN_LAST_STATE__
};


#define InnermostStates "Idle,Completed,Cooking,CookingPause,Error;"
const unsigned short oven_state_idx[]={
	0,5,11,21,29,42,48,68};
