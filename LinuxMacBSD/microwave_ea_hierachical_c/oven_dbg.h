...
const char oven_states[]=
	"Completed\0Super\0Cooking\0Idle\0Error\0CookingPause\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Completed,Super,Cooking,Idle,Error,CookingPause,__OVEN_LAST_STATE__
};


#define InnermostStates "Completed,Cooking,Idle,Error,CookingPause;"
const unsigned short oven_state_idx[]={
	0,10,16,24,29,35,48,68};
