...
const char oven_states[]=
	"Super\0Idle\0Cooking\0Completed\0CookingPause\0Error\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Super,Idle,Cooking,Completed,CookingPause,Error,__OVEN_LAST_STATE__
};


#define InnermostStates "Idle,Cooking,Completed,CookingPause,Error;"
const unsigned short oven_state_idx[]={
	0,6,11,19,29,42,48,68};
...
const char oven_events[]=
	"evTimeout\0eDoorOpen\0evDec\0evDoorOpen\0evDoorClosed\0evInc\0evPwr\0NO_MSG\0";


/* Event values */
const unsigned short oven_event_values[]={
	evTimeout,eDoorOpen,evDec,evDoorOpen,evDoorClosed,evInc,evPwr,OVEN_NO_MSG
};
