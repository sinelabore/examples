...
const char oven_states[]=
	"Super\0Idle\0Completed\0CookingPause\0Cooking\0__OVEN_LAST_STATE__\0";


/* State values */
const unsigned short oven_state_values[]={
	Super,Idle,Completed,CookingPause,Cooking,__OVEN_LAST_STATE__
};


#define InnermostStates "Idle,Completed,CookingPause,Cooking;"
